...
function Kiszamol(szam) {
	...
	TSE = szamki //Ha belülrõl hívta a végén retunrolja
	//ezres (mille, mila)
	if (szam.length>=4) {
	...
	//sorszám 2.
	if (sorszam) {szamki = "<br>Hímnem: <b>" + szamki.substring(0,szamki.length-1) + "esimo</b><br>" + "Nõnem : <b>" + szamki.substring(0,szamki.length-1) + "esima</b>"}
